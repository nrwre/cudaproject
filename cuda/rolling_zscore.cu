// Standalone executable for the naive sensor-major kernel. Kernel + launcher
// live in kernels.cu (shared with rolling_zscore_coalesced.cu and the
// pybind11 bindings); this file is just file I/O.
//
...
int main(int argc, char** argv) {
    ...
    launchRollingZScore(h_data.data(), h_anomalies.data(), num_sensors, num_timesteps, window, threshold, &kernel_ms);
